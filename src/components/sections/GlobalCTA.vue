...
.cta-banner {
  ...
  border: 1px solid rgba(20, 51, 105, 0.24);
  box-shadow: 0 28px 90px rgba(20, 51, 105, 0.14);
  position: relative;
  overflow: hidden;
}
...
.cta-card-new {
  background: #ffffff87;
  border: 1px solid rgba(20, 51, 105, 0.12);
  border-radius: 16px;
  padding: 36px 24px;
  display: flex;
...
.cta-card-new:hover {
  ...
  box-shadow: 0 18px 40px rgba(20, 51, 105, 0.08);
}
...
.btn-cta-gold {
  ...
  box-shadow: 0 8px 20px rgba(20, 51, 105, 0.25);
}

.btn-cta-gold:hover {
  background: #0c2145;
  transform: translateY(-1px);
  box-shadow: 0 10px 24px rgba(20, 51, 105, 0.35);
}
